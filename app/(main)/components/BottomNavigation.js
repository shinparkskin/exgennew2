...
export default function BottomNavigationBar() {
  ...
  return (
    <div class="fixed z-50 w-[80vw] h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-2 left-1/2 dark:bg-gray-700 dark:border-gray-600 shadow-md">
      <div class="grid h-full max-w-lg grid-cols-3 mx-auto">
        ...
        <div class="flex items-center justify-center pp5">
          <button
            data-tooltip-target="tooltip-new"
            type="button"
            class="inline-flex items-center justify-center w-10 h-10 font-medium bg-primary rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800"
