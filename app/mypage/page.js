      ...
      >
        ...
        <div>
          <div>
            <div class="space-y-6">
              <div class="md:flex items-start gap-10">
                <label class="w-40 text-right font-semibold">
                  {" "}
                  Who can follow me ?{" "}
                </label>
              ...
              <div class="md:flex items-start gap-10">
                <label class="md:w-40 text-right font-semibold">
                  {" "}
                  Who can message me ?{" "}
                </label>
                ...
                <div class="w-full">
                  <label class="switch flex justify-between items-center cursor-pointer gap-4">
                    ...
                    <div class="flex-1 md:pr-8">
                      ...
                      <p class="">
                        {" "}
                        You can receive notifications through your notifications
                        center{" "}
                      </p>
                    </div>
                    <input type="checkbox" />
                ...
                <div class="w-full">
                  <label class="switch flex justify-between items-center cursor-pointer gap-4">
                    ...
                    <div class="flex-1 md:pr-8">
                      ...
                      <p class="">
                        {" "}
                        You can receive notifications on your phone, so you can
                        stay up-to-date even when you’re on the go
                      </p>
                    </div>
                    <input type="checkbox" checked />
                    <span class="switch-button !relative"></span>
